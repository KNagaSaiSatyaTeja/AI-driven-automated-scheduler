...
export default function Dashboard() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 mb-2">College Room Scheduler</h2>
        <p className="text-slate-600">Manage and visualize class schedules across all rooms and faculty</p>
      </div>
